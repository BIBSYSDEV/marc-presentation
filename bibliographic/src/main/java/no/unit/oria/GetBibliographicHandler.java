 ...
 */
public class GetBibliographicHandler implements RequestHandler<Map<String, Object>, GatewayResponse> {
...
//    protected final transient BareConnection bareConnection;
    ...
    public GetBibliographicHandler() {
//        this.bareConnection = new BareConnection();
    }

//    public no.unit.oria.GetAuthorityHandler(BareConnection bareConnection) {
...
//    }
     ...
     * @return a no.unit.oria.GatewayResponse
     */
    @Override
