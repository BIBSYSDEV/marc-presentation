...
public class GatewayResponse {
    ...
    /**
     * no.unit.oria.GatewayResponse contains response status, response headers and body with payload resp. error messages.
     */
    ...
    /**
     * no.unit.oria.GatewayResponse convenience constructor to set response status and body with payload direct.
     */
